...
NProduction = {
	...
	BASE_FACTORY_SPEED = 0.2, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_MIL = 0.5, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_NAV = 0.2, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 6.0,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
...
NMilitary = {
	...
	ENCIRCLED_PENALTY = -0.1,                      -- penalty when completely encircled
